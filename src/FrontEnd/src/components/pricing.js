...
Pricing.defaultProps = {
  ...
  plan3Feature1: 'Premium autoinvesting AI bot',
  plan2Feature3: 'Monthly or yearly subscription',
  plan1Price1: '$200/yr',
  plan2: 'Business plan',
  plan2Feature21: 'Feature text goes here',
  plan2Action1: 'Get started',
  plan3Feature2: 'Unlimited portfolio customization options',
  content1: 'Choose the perfect plan for you',
  plan2Feature1: 'Advanced autoinvesting capabilities',
  ...
  plan1Feature1: 'Access to basic autoinvesting features',
  plan3Feature3: 'Monthly or yearly subscription',
