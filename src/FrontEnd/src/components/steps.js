...
Steps.defaultProps = {
  step1Description:
    'Create an account on our platform to get started with autoinvesting.',
  step3Description:
    'Link your bank account or investment portfolio to enable automated investments.',
  step2Title: 'Set Preferences',
  step2Description:
    'Customize your investment preferences such as risk tolerance and investment goals.',
  step1Title: 'Sign Up',
  step3Title: 'Connect Account',
  step4Description:
    'Let our AI-powered bot handle the investing based on your preferences.',
  step4Title: 'Sit Back and Relax',
}
